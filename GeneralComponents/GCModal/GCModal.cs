...
//
namespace GeneralComponents.GCModal
{
    public class GCModal : ComponentBase
    {
        ...
        public void DismissModal(string popupId)
        {
            ...
            EntryStack.Pop();
//            if (EntryStack.Count == 0)
//                GCDOMHelpers.setModalState(jsRuntime, false);
        }
...
//                    GCDOMHelpers.setModalState(jsRuntime, true);
            }
        }
